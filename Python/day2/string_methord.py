...
# print((name.strip()).endswith("!"))        #This method checks if the string ends with a given value. If yes then return True, else return False.
...
# print(name.find("Deve"))    #The find() method searches for the first occurrence of the given value and returns the index where it is present.
# print(name.find("disr"))     #If given value is absent from the string then return -1.
...
# print(h.swapcase())       # if character is in smaller then swap to capital else swap to smaller
